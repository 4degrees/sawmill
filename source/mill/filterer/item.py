...
class Item(Filterer):
    ...
    def __init__(self, key, value, mode=INCLUDE):
        ...
        *mode* can be either :py:attr:`~mill.filterer.item.Item.EXCLUDE` or
        :py:attr:`~mill.filterer.item.Item.INCLUDE`. If set to
        :py:attr:`~mill.filterer.item.Item.EXCLUDE` then any log that has the
        specific *key*, *value* pair will be filtered. Conversely, if set to
        :py:attr:`~mill.filterer.item.Item.INCLUDE` then any log not matching
    ...
    def filter(self, logs):
        ...
        :py:attr:`~mill.filterer.item.Item.INCLUDE` it will be filtered.
        Conversely, if mode is set to
        :py:attr:`~mill.filterer.item.Item.EXCLUDE` it will not be filtered.
