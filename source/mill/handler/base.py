...
class Handler(object):
    '''Handle a :py:class:`~mill.log.Log`, outputting it in a relevant way.'''
    ...
    def __init__(self, filterer=None, formatter=None):
        ...
        :py:class:`~mill.filterer.base.Filterer` and will be used to determine
        whether to handle a log or not.

        *formatter* should be an instance of
        :py:class:`~mill.formatter.base.Formatter` and will be called to format
